...
@section('content')
    ...
    <form id="form-login" autocomplete='off' action="{{ route('AdminAuthControllerPostLoginPKBM') }}" method="post">
        {!! csrf_field() !!}
        <div class="form-group has-feedback">
            <label for="">NPSN</label>
            <input autocomplete='off' type="text" class="form-control" name='npsn' required placeholder="Masukan NPSN"/>
